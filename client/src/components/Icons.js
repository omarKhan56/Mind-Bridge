...
export const Sparkles = ({ className = "w-6 h-6" }) => (
  <svg className={className} fill="currentColor" viewBox="0 0 24 24">
    <path d="M9.5 2L8.5 5.5L5 6.5L8.5 7.5L9.5 11L10.5 7.5L14 6.5L10.5 5.5L9.5 2ZM19 6L17.5 8.5L15 10L17.5 11.5L19 14L20.5 11.5L23 10L20.5 8.5L19 6ZM6 13L4.5 15.5L2 17L4.5 18.5L6 21L7.5 18.5L10 17L7.5 15.5L6 13Z"/>
  </svg>
);
